...
export function NavPage() {
    ...
    <div className={styles.navPageContent}>
        ...
        className={styles.acessBtn}>
            <a href="#">Sobre mim <Image src='/arrowsLink.png' alt='' width={25} height={25} className={styles.arrows}/></a>
        </motion.button>
        <motion.button
        variants={{
            hidden:{opacity: 0, x:150},
        ...
        className={styles.acessBtn}>
            <a href="#">Contato <Image src='/arrowsLink.png' alt='' width={25} height={25} className={styles.arrows}/></a>
        </motion.button>
    </div>
    </>
}